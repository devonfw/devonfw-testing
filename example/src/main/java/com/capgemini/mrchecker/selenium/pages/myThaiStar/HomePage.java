...
public class HomePage extends BasePage {
	...
	public boolean isLoaded() {
		...
		return getDriver().getCurrentUrl()
				.equals(GetEnvironmentParam.MAY_THAI_STAR_URL.getValue() + PageSubURLsMyThaiStar.HOME.getValue());
	}
	
	@Override
	public void load() {
		getDriver().get(GetEnvironmentParam.MAY_THAI_STAR_URL.getValue() + PageSubURLsMyThaiStar.HOME.getValue());
		getDriver().waitForPageLoaded();
	}
