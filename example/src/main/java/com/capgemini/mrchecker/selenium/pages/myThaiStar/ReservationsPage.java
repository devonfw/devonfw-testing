...
public class ReservationsPage extends BasePage {
	...
	private static final By selectorSearchFilterBar = By.cssSelector("mat-expansion-panel-header[id='mat-expansion-panel-header-1']");
	...
	public boolean isLoaded() {
		...
		return getDriver().getCurrentUrl()
				.equals(GetEnvironmentParam.MAY_THAI_STAR_URL + PageSubURLsMyThaiStar.RESERVATIONS.getValue());
	}
